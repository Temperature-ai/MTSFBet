...
class MTSFBet(Module):
    ...
    def forward_once(self, x):
        Task_1, Task_2 = self.Branch(x)
        return Task_1, Task_2

    def forward(self, input_1, input_2):
        Task_1_1, Task_2_1 = self.forward_once(input_1)
        Task_1_2, Task_2_2 = self.forward_once(input_2)
        Task_2 = self.cos_sim(Task_2_1, Task_2_2)
        return Task_1_1, Task_1_2, Task_2
